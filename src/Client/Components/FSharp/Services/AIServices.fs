...
[<ReactComponent>]
let AiSalesPage = React.functionComponent(fun () ->
    Html.div [
        ...
        prop.children [
            Html.section [
                prop.className "hero bg-white shadow-lg rounded-lg p-12 text-center"
                prop.children [
                    Html.h1 [ prop.className "text-5xl font-bold"; prop.text "Scale Your Business with AI-Driven Automation" ]
                    Html.p [ prop.className "mt-4 text-lg text-gray-700"
            ...
            Html.section [
                prop.children [
                    Html.h2 [ prop.className "text-3xl font-semibold text-center mb-6"; prop.text "Core Modules" ]
                    Html.div [
                        ...
                        prop.children (
                            ...
                            |> List.map (fun (title, desc) ->
                                Html.div [
                                    prop.className "card bg-white shadow-md p-6"
                                    prop.children [
                                        Html.h3 [ prop.className "text-xl font-medium mb-2"; prop.text title ]
                                        Html.p [ prop.className "text-gray-600"; prop.text desc ]
                                    ]
                                ])
                        )
                    ]
            ...
            Html.section [
                prop.children [
                    Html.h2 [ prop.className "text-3xl font-semibold text-center mb-6"; prop.text "Integration & Automation Tiers" ]
                    Html.div [
                        ...
                        prop.children (
                            ...
                            |> List.map (fun (tier, items) ->
                                Html.div [
                                    prop.className "card bg-white shadow-md p-6"
                                    prop.children [
                                        Html.h3 [ prop.className "text-xl font-medium mb-4"; prop.text tier ]
                                        Html.ul [
                                            prop.className "list-disc pl-5 text-gray-600 space-y-2"
            ...
            Html.section [
                prop.children [
                    Html.h2 [ prop.className "text-3xl font-semibold text-center mb-6"; prop.text "Pricing Plans" ]
                    Html.div [
                        prop.className "overflow-x-auto"
                        prop.children [
                            Html.table [
                                prop.className "table w-full bg-white shadow-md"
                                prop.children [
                                    Html.thead [
                                        Html.tr [
                                            Html.th "Plan"
            ...
            Html.section [
                prop.children [
                    Html.h2 [ prop.className "text-3xl font-semibold text-center mb-6"; prop.text "Typical First-Month Impact" ]
                    Html.div [
                        ...
                        prop.children (
                            ...
                            |> List.map (fun (label, value) ->
                                Html.div [
                                    prop.className "stat"
                                    prop.children [
                                        Html.div [ prop.className "stat-title"; prop.text label ]
