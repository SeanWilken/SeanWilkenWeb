...
//                     ]
//                     Html.h1 [
//                         prop.className "cormorant-font text-4xl md:text-5xl font-extrabold text-base-content"
        ...
        prop.children [
            Html.div [
                ...
                prop.children [
                    ...
                    Html.div [
                        ...
                        prop.children [
                            ...
                            Html.div [
                                ...
                                prop.children [
                                    ...
                                    Html.p [
                                        ...
                                        prop.text (tileContents[0].Summary)
                                    ]
                                ]
                            ]
                            // Industry
                            Html.div [
                                prop.className "info-card text-center"
                                prop.children [
                                    LucideIcon.Briefcase "w-10 h-10 mx-auto mb-6 opacity-60"
                                    Html.h3 [
                                        prop.className "cormorant-font text-2xl font-light mb-3"
                                        prop.text "Industry"
                                    ]
                                    Html.p [
                                        prop.className "text-[0.76rem] sm:text-xs opacity-50 leading-relaxed"
                                        prop.text (tileContents[1].Summary)
                                    ]
                                ]
                            ]
                            // Personal (highlighted)
                            Html.div [
                                prop.className "info-card highlighted text-center"
                                prop.children [
                                    LucideIcon.UserCircle "w-10 h-10 mx-auto mb-6 opacity-60"
                                    Html.h3 [
                                        prop.className "cormorant-font text-2xl font-light mb-3"
                                        prop.text "Personal"
                                    ]
                                    Html.p [
                                        prop.className "text-[0.76rem] sm:text-xs opacity-50 leading-relaxed"
                                        prop.text (tileContents[2].Summary)
                                    ]
                                ]
                            ]
                        ]
                    ...
                    // Hero image (uses .hero-image CSS)
                    Html.div [
                        prop.className "hero-image mb-16 md:mb-24 rounded-2xl overflow-hidden"
                        prop.children [
                            Html.img [
                                prop.src (tileContents[0].Image |> Option.defaultValue "./img/josh-boak-unsplash-overview.jpg")
                                prop.alt "About hero"
                    ...
                    Html.div [
                        ...
                        prop.children [
                            ...
                            Html.h2 [
                                ...
                                prop.text "Get to know the person behind the code: my interests, adventures, and what drives me outside of work."
                            ]

                            Html.p [
                                prop.className "text-sm opacity-70 leading-loose whitespace-pre-line"
                                prop.text personalDetailsText
                            ]
                        ]
                    ]
                ]
...
[<ReactComponent>]
let AboutCta (dispatch: WebAppMsg -> unit) =
    Html.section [
                    ...
                    Html.div [
                        ...
                        prop.children [
                            Html.button [
                                ...
                                prop.text "Explore projects & demos"
                                prop.onClick (fun _ ->
                                    dispatch (SwitchToOtherApp PortfolioAppLandingView)
                                )
                            ]
                            Html.button [
                                prop.className "cta-btn"
                                prop.text "Explore services offered"
                                prop.onClick (fun _ ->
                                    dispatch (SwitchToOtherApp (ProfessionalServicesAppView ServicesLanding))
                                )
                            ]
                        ]
                    ]
...
[<ReactComponent>]
let View (_model: SharedAboutSection.Model) (dispatch: WebAppMsg -> unit) =
